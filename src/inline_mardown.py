...
Original implementation for reference on where you got it wrong
"""
def text_to_text_nodes(text):
     input_text_node = TextNode(text, text_type_text)
     output_list = split_nodes_delimiter([input_text_node], "**", text_type_bold)
